                ...
                return (
                  ...
                  >
                    ...
                    >
                      ...
                      {event.location && (
                        <div className="flex items-center justify-center space-x-1 text-xs text-gold-500">
                    ...
                    >
                      <h4 className="font-semibold text-gold-900 mb-2">{event.title}</h4>
                      <p className="text-sm text-gold-600 mb-3">{event.description}</p>
                      
                      <div className="space-y-2">
                        <div className="flex items-center space-x-2 text-xs text-gold-500">
                ...
                <div className="p-6 max-h-[50vh] overflow-y-auto">
                  <div className="space-y-4">
                    <div>
                      ...
                      <p className="text-gold-600">{selectedEvent.description}</p>
                    </div>
                    ...
                    <div>
                      <h4 className="font-semibold text-gold-900 mb-2">Participants</h4>
                    ...
                    <div className="flex items-center justify-between pt-4 border-t border-gold-200">
                      <div className="flex items-center space-x-2">
                        ...
                        <span className="text-sm text-gold-600">Importance</span>
                      </div>
                      
                      <div className="flex items-center space-x-2 text-sm text-gold-500">
