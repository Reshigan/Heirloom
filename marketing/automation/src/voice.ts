...
End with ONE gentle question about THEIR own experience — that is the primary comment driver, and comments are the ranking signal. 1–3 community + discovery tags so the post lands on the family-history / genealogy / memory-keeping group pages where the audience already gathers (#familystories, #familyhistory, #genealogy, #oralhistory, #memorykeeping, #familyroots, #knowyourroots, #preservestories) — pick the ones that fit THIS post, never a tag wall, never decorative emoji. No link in the caption (Facebook demotes link posts ~50%); the link auto-posts as the first comment.`,
...
THREAD STRUCTURE: Post 1 = the observation (≤280 chars, stands alone). Post 2 = one concrete development — a specific example or quietly stated detail (200–280 chars). Post 3 = the smallest possible action, no pitch ("Ask one person this week. Set the answer to open on a birthday that hasn't come yet."). 1–4 discovery tags on the FINAL post only (#familystories, #familyhistory, #genealogy, #oralhistory, #memorykeeping, #familyroots, #knowyourroots), counted against the 300-char cap. No product mention — the thread itself is the demonstration. Never lead with loss; lead with the living person.`,
};
