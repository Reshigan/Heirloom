...
export const PLATFORM_GUIDELINES = {
  instagram: `Instagram caption. 60–160 words. The visual does most of the work — the caption goes deeper, not wider. Hook in first 80 chars (above the "more" cut): one specific, concrete sentence that makes the reader feel something without explaining why. Then: one paragraph — 2-4 sentences — of the actual idea. No bullet points, no emojis except one if it earns it. End with one engagement CTA: either "Drop their name 👇" or "Save this for [specific occasion]" or "Tag someone who needs to hear this." Then 8–12 lowercase hashtags mixing: 2-3 intent tags (#questionstoaskmom, #questionstoaskdad, #thingstodowithagingparents), 3-4 community tags (#familyhistory, #genealogy, #ancestors, #familytree), 2-3 emotion tags (#memoriesforever, #neverforget, #familylove, #generationalgift), 1-2 discovery tags (#digitallegacy, #familyarchive, #legacyplanning). Pick the ones that fit the specific theme.`,
...
End with one personal question about THEIR own experience — this is the primary comment driver, and comments are the algorithm signal. No hashtags. No link in the caption (Facebook suppresses link posts by ~50%); link auto-posts as first comment.`,
