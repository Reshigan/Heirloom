      ...
      <div style={{ overflowY: 'auto', minHeight: '100%' }}>
        ...
        >
          <RoomHeader
            ...
            lede="Each entry settles as a point of dye. The Deep grows denser with every year. These patterns are illustrative — generated to show the form, not real account data."
          />
