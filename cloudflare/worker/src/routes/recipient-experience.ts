...
recipientExperienceRoutes.post('/memory-room/invite', async (c) => {
  ...
  try {
    await sendEmail(c.env, {
      ...
      html: `
        <div style="font-family: Georgia, serif; max-width: 600px; margin: 0 auto; padding: 40px 20px; background: #070d14; color: #f5f0e8;">
          <h1 style="color: #cf8248; text-align: center; font-weight: normal; margin-bottom: 30px;">You're Invited to Share Memories</h1>
          ...
          <div style="text-align: center; margin: 40px 0;">
            <a href="${roomUrl}" style="display: inline-block; padding: 16px 32px; background: #cf8248; color: #070d14; text-decoration: none; border-radius: 0; font-weight: bold; font-size: 16px;">Share Your Memories</a>
          </div>
          ...
          <p style="text-align: center; color: #f5f0e860; font-size: 12px;">
            Sent with love through <a href="https://heirloom.blue" style="color: #cf8248;">Heirloom</a>
          </p>
        </div>
      `,
    }, 'MEMORY_ROOM_INVITE');
