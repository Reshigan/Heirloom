          ...
          await sendEmail(c.env, {
            ...
            html: `
              <div style="font-family: Georgia, serif; max-width: 600px; margin: 0 auto; padding: 40px 20px; background: #070d14; color: #f5f0e8;">
                <h1 style="color: #cf8248; text-align: center; font-weight: normal;">A Message for Your ${trigger.event_name}</h1>
                ...
                <div style="text-align: center; margin: 30px 0;">
                  <a href="${c.env.APP_URL || 'https://heirloom.blue'}/inherit" style="display: inline-block; padding: 15px 30px; background: #cf8248; color: #0a0c10; text-decoration: none; border-radius: 0; font-weight: 600;">View Your Message</a>
                </div>
