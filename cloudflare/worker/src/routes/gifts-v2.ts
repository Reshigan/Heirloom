      ...
      html: `
        <div style="font-family: Georgia, serif; max-width: 600px; margin: 0 auto; background: #0a0c10; color: #f5f3ee; padding: 40px;">
          <div style="text-align: center; margin-bottom: 30px;">
            ...
            <h1 style="color: #cf8248; font-family: Georgia, serif; margin: 8px 0;">You've received a gift</h1>
          </div>
          <p style="font-size: 18px; line-height: 1.6;">
            <strong>${senderName}</strong> has shared something special with you: <em>&ldquo;${escapeHtml(memoryTitle)}&rdquo;</em>
          </p>
          ${body.personal_message ? `<div style="background: rgba(242,230,208,0.05); padding: 20px; border-radius: 12px; margin: 24px 0; border-left: 3px solid #cf8248;"><p style="font-style: italic; color: #f5f3ee;">&ldquo;${escapeHtml(String(body.personal_message))}&rdquo;</p></div>` : ''}
          <div style="text-align: center; margin: 32px 0;">
            <a href="${giftUrl}" style="display: inline-block; padding: 16px 40px; background: #cf8248; color: #0a0c10; text-decoration: none; border-radius: 0; font-weight: bold; font-size: 16px;">
              Unwrap Your Gift
            </a>
          </div>
