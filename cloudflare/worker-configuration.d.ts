/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: e9a8a2d2b7e7d927765d0065bc8b4342)
// Runtime types generated with workerd@1.20260401.1 2024-12-01 nodejs_compat
declare namespace Cloudflare {
	...
	interface StagingEnv {
		...
		DB: D1Database;
		ENVIRONMENT: "staging";
		APP_URL: "https://staging.heirloom.blue";
		JWT_SECRET: string;
	...
	interface Env {
		...
		APP_URL: "https://staging.heirloom.blue" | "http://localhost:3000" | "https://heirloom.blue";
		JWT_SECRET: string;
		STRIPE_SECRET_KEY: string;
		RESEND_API_KEY: string;
		ENCRYPTION_MASTER_KEY: string;
		...
		ADMIN_NOTIFICATION_EMAIL?: "admin@heirloom.blue";
		VAPID_PUBLIC_KEY?: "nuiTXfo2MgIaSGqGMtQWPUU31OtXkBe3WT46vuHj-Bz0TfPg_XFvXskqlsZw-As_v0f-7iXtz1pt2TK28OQh-w";
		VAPID_SUBJECT?: "mailto:admin@heirloom.blue";
